    ...
    return (
        ...
        <main className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="grid justify-center gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Link to="/recipe-adding">
                    <div className='bg-gradient-to-br from-gray-100 to-gray-300 flex h-full rounded-lg shadow-md overflow-hidden text-gray-600 hover:scale-105 transition-transform duration-300'>
                        <p className='justify-centers mx-auto my-48 text-xl'>Add A Recipe</p>
                    </div>
                </Link>
            </div>
        </main>
