    ...
    return (
        <body className="bg-white">
            <main className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="grid justify-center gap-6 sm:grid-cols-1 lg:grid-cols-2 w-[600px]">
                    {recipes.map(recipe => (
                        <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition" key={recipe.id}>
                            ...
                            <a href="" className='inline-block px-4 py-2 bg-yellow-500 text-white rounded m-4 hover:bg-yellow-600'>
                                View Recipe
                            </a>
                        </div>
                    ))}
